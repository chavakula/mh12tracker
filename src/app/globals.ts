export let SETTINGS = {
    baseApiUrl: 'https://api.mh12.org',
    metaApiUrl: 'meta-details.json',
    newsApiUrl: 'news.json',
    summaryApiUrl: 'summary.json',
    summaryPcmcApiUrl: 'pcmc-cases.json',
    ...
    summaryDeltaGraphPcmc: 'pcmc-daily-graph.json',
    patientSummary: 'patient-summary-delta.json',
    patientSummaryGraph: 'patient-summary-graph.json',
